...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Center log
        self.center_coordinates = QLabel("Центр фигуры в данный момент: (0, 0)", self)
    ...
    def __setup_rotation_interface(self):
        ...
        self.rotate_angle_input.setFixedSize(QSize(self.input_section_width * 2, 30))
    ...
    def __setup_scaling_interface(self):
        ...
        self.scale_ratio_input.setFixedSize(QSize(self.input_section_width * 2, 30))
